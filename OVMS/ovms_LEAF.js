//-------------------------------------//
// Before uploading: can can2 stop

const vehicle_id = "FRV020";
...
function GetUrlABRP() {
    ...
    urljson += "speed=" + OvmsMetrics.AsFloat(["v.p.speed"]).toFixed(8)+ "&";
    ...
    urljson += "capacity=" + OvmsMetrics.AsFloat("xnl.v.b.e.available") + "&";
    ...
    urljson += "power_kw=" + OvmsMetrics.AsFloat("v.b.power") + "&";
