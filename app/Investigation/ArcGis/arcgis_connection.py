...
stops = (
    """ -75.579519,6.199303; -75.541652, 6.153382"""  # palmeras : -75.580855,6.151992
)
...
result = route_layer.solve(
    ...
    directions_output_type="esriDOTFeatureSets",
...
fig = go.Figure(
    go.Scattermapbox(
        mode="markers+lines", lon=points["x"], lat=points["y"], marker={"size": 10}
    )
)
