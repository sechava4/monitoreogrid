...
X_transformed = features[['max_current', 'max_power','std_jerk',
                          'prom_abs_current']].values
"""
X_transformed = features[["max_current", "max_pot", "slope"]].values
...
for n_clusters in range_n_clusters:
    ...
    ax2.set_title("The visualization of the clustered osm_data.")
    ax2.set_xlabel("Feature space for the 1st feature")
    ax2.set_ylabel("Feature space for the 2nd feature")

    plt.suptitle(
        (
            "Silhouette analysis for KMeans clustering on sample osm_data "
