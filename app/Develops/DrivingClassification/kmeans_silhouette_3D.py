...
selected_ftrs = features[['std_acc', 'prom_abs_jerk', 'std_jerk', 'std_pot', 'prom_abs_pot',
                        'prom_abs_current', 'std_current',
                        'std_current_std_jerk', 'slope', 'max_current', 'max_jerk', 'max_acc', 'max_pot',
...
X_transformed = features[['max_current', 'max_power','std_jerk',
                          'prom_abs_current']].values
'''
X_transformed = features[['consumption_per_km', 'max_pot',
                          'slope']].values
...
for n_clusters in range_n_clusters:
    ...
    ax = Axes3D(fig)
    ax.scatter(X_transformed[:, 0], X_transformed[:, 1], X_transformed[:, 2], c=colors, s=10)
    ...
    plt.suptitle(("Silhouette analysis for KMeans clustering on driving data "
