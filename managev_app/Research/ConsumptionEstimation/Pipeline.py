...
# from managev_app.models import OSM
# Save model
import pickle

import managev_app.Research.OpenStreetMaps.associate_edges_to_operation as associate
...
if __name__ == "__main__":
    ...
    mean_features_by_user_and_slope.rename(
        columns={"max_power": "mean_max_power_usr"}, inplace=True
    )
